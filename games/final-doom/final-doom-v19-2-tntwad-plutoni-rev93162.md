...
https://lutris.net/api/installers/games/final-doom/revisions/93162
...
```
Ensure filenames will be correct
```
...
- execute:
    ...
    file: mkdir
- execute:
    args: -n tntwad192 $GAMEDIR/wads/TNT.WAD
    file: cp
- execute:
    args: -p $GAMEDIR/savegames/tnt.wad
    file: mkdir
- execute:
    args: -n plutoniawad192 $GAMEDIR/wads/PLUTONIA.WAD
    file: cp
- execute:
